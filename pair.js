...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://files.catbox.moe/120aye.jpg',
...
> Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ ʙᴏᴛ 🔥`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://files.catbox.moe/120aye.jpg" },
        caption: `Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ  ʙᴏᴛ\n\n${captionText}`,
    }, { quoted: msg });
...
case 'active': {
    ...
    try {
        const url = `https://sannu-x-mini-bot-v2-1.onrender.com?number=${encodeURIComponent(number)}`;
